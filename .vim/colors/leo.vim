...
hi Normal				cterm=none		ctermfg=249		ctermbg=232 guifg=#a0aabb	guibg=#0c0c0c
hi CursorLine		cterm=none		ctermbg=16		guibg=#00111f
...
hi Comment			cterm=none		ctermfg=23  gui=italic		guifg=#00445a
hi Conditional	cterm=none		ctermfg=40		guifg=#0087ff
...
hi Exception		cterm=bold		ctermfg=226		gui=none			guifg=#776640
hi Function			cterm=none		ctermfg=221		guifg=#55bb44
...
hi Operator			cterm=none		ctermfg=214		guifg=#ffff00
hi PreProc			cterm=none		ctermfg=202		guifg=#ff5f00
hi Special			cterm=none		ctermfg=206		ctermbg=234		guifg=#ff5fd7 guibg=#1c1c1c
hi Statement		cterm=none		ctermfg=51		gui=none			guifg=#37bfb6
"hi String				cterm=none		ctermfg=224		ctermbg=234		guifg=#ffd7d7	guibg=#1c1c1c
hi String				cterm=none		ctermfg=180		ctermbg=233		guifg=#afa587	guibg=#101012
hi Todo					cterm=none		ctermfg=16		ctermbg=226		guifg=#000000 guibg=#aa5500
